...
namespace Adrianogl\Scaffold\Migrations;

use Adrianogl\Scaffold\GeneratorException;


/**
 * Class SyntaxBuilder with modifications by Adriano Gonçalves
 * @package Adrianogl\Scaffold\Migrations
